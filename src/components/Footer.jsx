...
export default function Footer() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-0.15" className='w-full h-full bg-zinc-900 p-20 flex  gap-5 '>
        <div className='w-1/2  font-["GOST_Common"] text-[11vh] tracking-tighter leading-none font-extrabold flex flex-col justify-between'>
        ...
        <div className='w-1/2 h-[50vh]'>
            <h1 className='font-["GOST_Common"] text-[11vh] tracking-tighter leading-none font-extrabold'>PRESENTATION</h1>

            <h1 className='mt-[3vw] text-[18px] mb-[2vw]'>S:</h1>

            {["Instagram","Behance","Facebook","Linkedin"].map((item,index)=>(
                <h1 className='font-["Neue_Montreal_Regular"] font-light text-zinc-400 text-[18px]'>{item}</h1>
            ))}

            <div className='flex gap-14 mt-[10vh]'>
                <div className='det1 w-1/2'>
                <h1 className=' text-[18px] mb-[2vw]'>L :</h1>
                    {["202-1965 W 4th Ave","Vancouver, Canada"].map((item,index)=>(
                        <h1 className='font-["Neue_Montreal_Regular"] font-light text-zinc-400 text-[18px]'>{item}</h1>
                    ))}
                </div>
                <div className='det2 w-1/2'>
                <h1 className=' text-[18px] mb-[2vw]'>M :</h1>
